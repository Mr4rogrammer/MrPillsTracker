...
object CoreModule {
    ...
    @Provides
    fun getSavaDataDataSource(): SavaDataDataSource {
        return SaveDataRemoteDataSource()
    }

    @Provides
    fun getSaveDataRepository(savaDataDataSource: SavaDataDataSource):SaveDataRepository {
        return SaveDataRepositoryImpl(savaDataDataSource)
    }
